...
const page = () => {
  return (
    <>
      <div className="container max-w-full h-full flex flex-col p-[1rem] border-box">
        <div className="w-full flex flex-col bg-white p-[1rem] border-box border rounded-[0.25rem] border-none" > 
          <div className="flex flex-row justify-between items-center py-[1rem] border-box">
            ...
            <div className="flex flex-row justify-between items-center gap-[0.5rem]">
              ...
              <Link href="/users/new" className="action-btn"><Plus/> New</Link>
            </div>
          </div>
          <UserTable />
          <div className="flex flex-row justify-between items-center py-[1rem] border-box">
            ...
            <div className="flex flex-row gap-[0.5rem]">
              <button className="action-btn "><ArrowLeft />Prev</button>
              <select>
                <option>1</option>
              </select>
              <button className="action-btn ">Next<ArrowRight /></button>
            </div>
          </div>
          ...
          <div className="flex flex-row justify-between items-center py-[1rem] border-box">
              ...
              <div className="flex flex-row gap-[0.5rem] items-center">
                ...
                <button className="action-btn ">Skip<ArrowRight /></button>
              </div>
          </div>
        </div>
      </div>
